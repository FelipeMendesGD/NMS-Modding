  ...
  [[
    ...
    <!-- MISSION BREAK-->
      <Property value="GcGenericMissionSequence.xml">
        <Property name="MissionID" value="CUSTOM1"/>
        ...
        <Property name="Stages">
          ...
          <Property value="GcGenericMissionStage.xml">
            ...
            <Property name="Stage" value="GcMissionSequenceReward.xml">
              ...
              <Property name="Reward" value="BREAK_ANY_TECH" />
    ...
    <!-- MISSION REPAIR-->
      <Property value="GcGenericMissionSequence.xml">
        <Property name="MissionID" value="CUSTOM2"/>
        <Property name="MissionClass" value="Secondary" />
        <Property name="MissionIsCritical" value="False" />
        <Property name="MissionObjective" value="MISSION_OBJ_COLLECT" />
        <Property name="MissionTitles" value="GcNumberedTextList.xml">
        ...
        <Property name="DefaultItems" value="GcDefaultMissionItemsTable.xml">
          <Property name="PrimarySubstances">
            <Property value="GcDefaultMissionSubstance.xml">
              <Property name="Substance" value="GcSubstanceTableEnum.xml">
                <Property name="Substance" value="OXYGEN" />
              </Property>
            </Property>
          </Property>
          <Property name="SecondarySubstances" />
        ...
        <Property name="Stages">
          ...
          <Property value="GcGenericMissionStage.xml">
            ...
            <Property name="Stage" value="GcMissionSequenceReward.xml">
              <Property name="Message" value="UI_REWARD_FAILED_MSG" />
              <Property name="Reward" value="REPAIR_ANY_TECH" />
              <Property name="CanOverride" value="False" />
              <Property name="DebugText" value="Give reward" />
            </Property>
          </Property>
...
--New Entry to RewardTable First Mission`s Reward
  R_BREAK_ANY_TECH =
  [[
        <Property value="GcGenericRewardTableEntry.xml">
        <Property name="Id" value="BREAK_ANY_TECH" />
  ...
  [[
      <Property value="GcGenericRewardTableEntry.xml">
        <Property name="Id" value="REPAIR_ANY_TECH" />
        <Property name="Common" value="GcRewardTableItemList.xml">
          <Property name="RewardChoice" value="GiveAll" />
          <Property name="OverrideZeroSeed" value="False" />
          <Property name="List">
...
--New Entry to RewardTable Reward Custom Mission 1
  RM_CUSTOM1 =
  [[
      <Property value="GcGenericRewardTableEntry.xml">
        <Property name="Id" value="RM_CUSTOM1" />
        <Property name="Common" value="GcRewardTableItemList.xml">
          <Property name="RewardChoice" value="GiveAll" />
          <Property name="OverrideZeroSeed" value="False" />
          <Property name="List">
            <Property value="GcRewardTableItem.xml">
              ...
              <Property name="Reward" value="GcRewardMission.xml">
                <Property name="Mission" value="CUSTOM1" />
...
--New Entry to AllienPuzzle
  P_CUSTOM_BEACON =
  [[
    <Property value="GcAlienPuzzleEntry.xml">
      <Property name="ProgressionIndex" value="-1" />
      <Property name="MinProgressionForSelection" value="0" />
      <Property name="Id" value="CustomBeacon_1" /> <!--Custom interaction name-->
      <Property name="Race" value="GcAlienRace.xml">
        <Property name="AlienRace" value="Atlas" />
      </Property>
      <Property name="Type" value="GcInteractionType.xml"> <!--Interaction type: Distress Beacon-->
      ...
      <Property name="AdditionalOptions" value="None" />
      <Property name="Title" value="TUTORIAL_BEACON_LANG" />
      <Property name="Text" value="" />
      <Property name="TextAlien" value="TUTORIAL_BEACON_DESC" />
      <Property name="TranslateAlienText" value="False" />
      <Property name="TranslationBrackets" value="False" />
      <Property name="ProgressiveDialogue" value="True" />
      <Property name="RequiresScanEvent" value="" />
      <Property name="Options">
        <Property value="GcAlienPuzzleOption.xml"> <!--Dialog option 1 Reward = Mission-->
          <Property name="Name" value="TUTORIAL_BEACON_OPT_A" />
          <Property name="Text" value="TUTORIAL_BEACON_RES_A" />
          <Property name="IsAlien" value="True" />
          <Property name="Cost" value="" />
          <Property name="Rewards">
            <Property value="NMSString0x10.xml">
              <Property name="Value" value="R_REVEAL_ABAND" />
            </Property>
          </Property>
          <Property name="Mood" value="GcAlienMood.xml">
            <Property name="Mood" value="Neutral" />
        ...
        <Property value="GcAlienPuzzleOption.xml"> <!--Dialog option 2 Reward = Damage-->
          <Property name="Name" value="TUTORIAL_BEACON_OPT_B" />
          <Property name="Text" value="TUTORIAL_BEACON_RES_B" />
          <Property name="IsAlien" value="True" />
          <Property name="Cost" value="" />
          <Property name="Rewards">
            <Property value="NMSString0x10.xml">
              <Property name="Value" value="DAMAGELARGE" />
            </Property>
          </Property>
          <Property name="Mood" value="GcAlienMood.xml">
            <Property name="Mood" value="Neutral" />
...
--Atach MissionTable Entity to LargeDesk
  E_MISSIONTABLE =
  [[
        <Property value="TkSceneNodeAttributeData.xml">
          <Property name="Name" value="ATTACHMENT" />
          <Property name="AltID" value="" />
          <Property name="Value" value="MODELS\CUSTOM_ENTITIES\MISSIONTABLE.ENTITY.MBIN" />
        </Property>
  ]]
  ...
  {
    {
      ...
      {  
          ...
          {
            {
              ...
              ["SECTION_UP"] = 0,
              ["ADD"] = R_BREAK_ANY_TECH,
              ["REPLACE_TYPE"] = "ADDAFTERSECTION",
            }
          }
        },

        {--Adds RepairTech Reward
          ["MBIN_FILE_SOURCE"] = "METADATA\REALITY\TABLES\REWARDTABLE.MBIN",
          ["EXML_CHANGE_TABLE"] =
          {
            {
              ["SPECIAL_KEY_WORDS"] = {"Id","REPAIR_TECH"},
              ["SECTION_UP"] = 0,
              ["ADD"] = R_REPAIR_ANY_TECH,
              ["REPLACE_TYPE"] = "ADDAFTERSECTION",
            }
          }
        },

        {--Adds Custom Mission 1 as Reward
          ["MBIN_FILE_SOURCE"] = "METADATA\REALITY\TABLES\REWARDTABLE.MBIN",
          ["EXML_CHANGE_TABLE"] =
          {
            {
        ...
        {--Adds the code from the FirstMission
        ...
        {--Adds interaction to Alien Puzzle
        ...
        {--Remove Attachment from LargeDesk
